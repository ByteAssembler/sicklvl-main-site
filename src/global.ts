...
export const luciaAdapter = new PrismaAdapter(prismaClient.session, prismaClient.customer);
...
export function validateAdminAuthentication(username: string, password: string) {
	return username === "admin" && password === "QdvPDDZ6&qnFY8H!Rk##WeV$U@s5Pj&pLfSeEY#$BEgVC6RcHyq!&@79sn%LNCogF^p&BsKtcNNwH4QHgbg$xM%TBGe#X#$bW3hn$LqWK8My4fD6$cUFdXaQ@Q%TL*PT";
}
